        ...
        <div class="">
            ...
            <div class="sub-aboutus-ceo">
                <div class="sub-about-ceo-pic">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ceo.jpg" alt="代表取締役社長の写真">
                </div>
                <div class="sub-aboutus-ceo-message">
                    <h3 class="sub-aboutus-ceo-main">あなたがやりたいこと<br>
                        それを全力でサポートできる、<br>
                        それがTETOTEの強みです。</h3>
                    ...
                    <img class="sub-aboutus-ceo-name" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ceo-name.svg" alt="">
                </div>
            </div>
        </div>
</section>
    ...
    <div class="sub-inner">
        ...
        <div class="sub-about-box about-box1">
            <div class="sub-about-box-img">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/about-consulting.jpg" alt="">
            </div>
            <div class="sub-about-career">
                <h3 class="sub-about-box-title">コンサルティング事業</h3>
                <h4 class="sub-about-box-item">お客様と伴走し、売上に直接貢献できる</h4>
                <p class="sub-about-box-read">営業との連携で、人と組織の成長・変革に向けた計画立案・サービス実施、さらにフォローまで。コンサルタントとして一気通貫で携わります。</p>
            </div>
        </div>

        <div class="sub-about-box">
            <div class="sub-about-box-img">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/about-solution-sales.jpg" alt="">
            </div>
            <div class="sub-about-career2">
                ...
                <p class="sub-about-box-read solution-read">お客様が抱える課題へ、ヒアリングベースで提案型営業を行い、コンサルタントとの連携で課題解決を目指します。</p>
            </div>
        </div>

        <div class="sub-about-box">
            <div class="sub-about-box-img">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/about-desiner.jpg" alt="">
            </div>
            <div class="sub-about-career3">
                ...
                <p class="sub-about-box-read system-read">基本設計書に従って開発とテストを実施し、本番稼働をサポート。企画から運用までの全工程を通じて包括的なアプローチで、安定した運用と迅速な対応を保証します。</p>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="sub-inner sub-inner-about-list">
        ...
        <div class="sub-about-list-sec">
            ...
            <dl class="sub-about-list">
                <dt class="sub-about-list-title">会社名</dt>
                <dd class="sub-about-list-item">
                    <?php echo esc_html(get_field('company_name') ?: 'TETOTE株式会社'); ?>
                </dd>
            </dl>
            ...
            <dl class="sub-about-list">
                ...
                <dd class="sub-about-list-item">
                    <?php
                    $address = get_field('company_address') ?: "〒100-0001\n東京都千代田区千代田 1-1-1";
            ...
            <dl class="sub-about-list">
                <dt class="sub-about-list-title">代表者名</dt>
                <dd class="sub-about-list-item">
                    <?php echo esc_html(get_field('company_ceo') ?: '田中 浩二郎 (代表取締役)'); ?>
                </dd>
            </dl>
            ...
            <dl class="sub-about-list">
                ...
                <div class="sub-about-list-consul">
                    <?php
                    $business_lines = get_field('business_content') ?: array(
                        'ITコンサルティング',
                        'コンサル導入企業への営業'
                    );
                    if (is_array($business_lines)) {
                        foreach ($business_lines as $line) {
                            echo '<dd class="sub-about-list-item">' . esc_html('・' . $line) . '</dd>';
                        }
                    } else {
                        echo '<dd class="sub-about-list-item">' . esc_html($business_lines) . '</dd>';
                    }
                    ?>
                </div>
            </dl>
            ...
            <dl class="sub-about-list">
                ...
                <dd class="sub-about-list-item">
                    <?php
                    $tel = get_field('company_phone') ?: '03-1234-5678';
                    ?>
                    <a href="<?php echo esc_url('tel:' . str_replace(array('−', '‐', '‑', '‑', '‒', '–', '—'), '', $tel)); ?>">
            ...
            <dl class="sub-about-list">
                <dt class="sub-about-list-title">ウェブサイト URL</dt>
                <dd class="sub-about-list-item">
                    <?php
                    $site = get_field('company_url') ?: 'https://tetote.co.jp';
                    ?>
            ...
            <dl class="sub-about-list">
                ...
                <dd class="sub-about-list-item">
                    <?php
                    $email = get_field('company_email') ?: 'tetote@tetote.co.jp';
                    ?>
                    <a href="<?php echo esc_url('mailto:' . $email); ?>" class="mail-link">
            ...
            <dl class="sub-about-list">
                <dt class="sub-about-list-title">設立年月</dt>
                <dd class="sub-about-list-item">
                    <?php echo esc_html(get_field('company_found_year') ?: '1923年4月1日'); ?>
                </dd>
            </dl>
