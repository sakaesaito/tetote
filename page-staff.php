            ...
            <div class="sub-staff-box-wrapper">
                <div class="sub-staff-box">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/syain01.jpg" alt="社員写真ー西村優">
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">「あなたが担当で良かった」</p>
                            <p class="sub-staff-box-message2">この一言が、最高のやりがい</p>
                ...
                <div class="sub-staff-box">
                    <a href="<?php echo home_url('/staff-single/'); ?>">
                        ...
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">全力で考えぬける環境</p>
                            <p class="sub-staff-box-message2">試練の数だけ強くなれました</p>
                            <div class="staff-box-post">
                                <p class="staff-box-position">コンサルタント</p>
                ...
                <div class="sub-staff-box">
                    <a href="<?php echo home_url('/staff-single/'); ?>">
                        ...
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">お客様も知らない課題を</p>
                            <p class="sub-staff-box-message2">一緒に探し出す醍醐味</p>
                            <div class="staff-box-post">
                ...
                <div class="sub-staff-box">
                    <a href="<?php echo home_url('/staff-single/'); ?>">
                        ...
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">ビジネスの課題を</p>
                            <p class="sub-staff-box-message2">データで解決する醍醐味を</p>
                            <div class="staff-box-post">
                ...
                <div class="sub-staff-box">
                    <a href="<?php echo home_url('/staff-single/'); ?>/staff-single/">
                        ...
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">どんな難解な案件も</p>
                            <p class="sub-staff-box-message2">チームで突破できる強い連携</p>
                            <div class="staff-box-post">
                                <p class="staff-box-position">コンサルタント</p>
                ...
                <div class="sub-staff-box">
                    <a href="<?php echo home_url('/staff-single/'); ?>/staff-single/">
                        ...
                        <div class="sub-staff-box-img">
                            <p class="sub-staff-box-message1">お客様と一緒に開発</p>
                            <p class="sub-staff-box-message2">豊富なプライム案件が魅力です</p>
                            <div class="staff-box-post">
