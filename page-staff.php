...
<section id="sub-staff" class="sub-sutaff">
    <div class="sub-mv" style="background-image: url('<?php echo get_template_directory_uri(); ?>/img/staff-fv.jpg');"style="background-size: cover;object-fit: contain;">
        ...
        <div class="sub-inner sub-inner-staff">
            <div class="sub-staff-sec">
                <div class="sub-staff-box-wrapper">
                    ...
                    <div class="sub-staff-box">
                        <a href="<?php echo home_url('/staff/'); ?>/staff/takahashi-satoru/">
